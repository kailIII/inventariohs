...
<body>
 ...
 <!-- ******************************************** INFORMACION DEL USUARIO QUE PRESTA LAS LLAVES ************************************** -->
          <div class="row">
            <h4> Informacion del Equipo a prestar</h4>
...
<!-- ********************************************************** BOTONES ************************************************************* -->
        <div class="row">
          <div class="columns large-2">
            <label for="soporte_ingresar_prestamo_soporte_switche">&nbsp;</label>
            <input type="button" name="soporte_ingresar_prestamo_soporte_switche" id="soporte_ingresar_prestamo_soporte_switche" value="Ingresar Prestamo" class="button">
          </div>
