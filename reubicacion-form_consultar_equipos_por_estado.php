  ...
  <body>
      ...
      <form method="post" action="reubicacion-php_enviar_sql_completo_excel.php">
        <div class="row">
          ...
          <div class="columns large-3">
            <label for="activo_equipo_retirar">Activo equipo a retirarr</label>
        ...
        <div class="row">
          <div class="columns large-4">
            <input type="button" name="consultar_estado_equipos_reubicados_por_pantalla" id="consultar_estado_equipos_reubicados_por_pantalla" value="Consultar orden de compra pantalla" class="button">
          </div>
        </div>
