...
$query = "SELECT reu_activo AS activo_equipo, tipos_equipo.tip_descripcion AS tipo_de_equipo,
...
reu_ot_sigma AS ot_sigma,
reu_observacion AS observaciones  FROM reubicaciones
...
WHERE reu_activo LIKE '%$activo_equipo%' AND reu_estado_equipo LIKE '%$id_est%'";
