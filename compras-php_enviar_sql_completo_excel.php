...
com_piso AS piso, com_cubiculo AS cubiculo, com_dir_ip AS dir_ip, com_dir_mac AS dir_mac, com_punto_de_red  AS punto_de_red, com_ot_sigma AS ot_sigma, com_observaciones AS observaciones  FROM compras 
